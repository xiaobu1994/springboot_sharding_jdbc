...
public class DataSourceConfig {
    ...
    private DataSource buildDataSource() throws SQLException {
        ...
        //分库分表策略 shardingValue.getValue为goods_id
        ShardingRule shardingRule = ShardingRule.builder()
                ...
                .tableShardingStrategy(new TableShardingStrategy("goods_id", (SingleKeyTableShardingAlgorithm<?>) tableShardingAlgorithm)).build();
